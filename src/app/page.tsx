          ...
          <div style={{ display: 'flex', height: '100vh', backgroundColor: '#0f172a' }}>
                    ...
                    <div style={{
                      ...
                      borderRight: '1px solid #334155'
                                ...
                                <div style={{ padding: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    {sidebarOpen && <h2 style={{ margin: 0, fontSize: '18px' }}>CRM</h2>h2>}
              ...
              {/* Main Content */}
                    <div style={{ flex: 1, overflow: 'auto', padding: '30px' }}>
                                <h1 style={{ color: '#fff', marginBottom: '30px', fontSize: '28px' }}>CRM Dashboard</h1>h1>
                        ...
                        <div>
                            ...
                            { label: '成功率', value: stats.successRate }
                                                              ...
                                                              <div key={i} style={{
                                                                                ...
                                                                                <p style={{ color: '#0ea5e9', margin: 0, fontSize: '32px', fontWeight: 'bold' }}>{stat.value}</p>p>
                                                              </div>div>
                                                            ))}
                                    </div>div>
                                                  ...
                                                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                                                  <thead>
                                                                                    <tr style={{ backgroundColor: '#0f172a', borderBottom: '1px solid #334155' }}>
                                                                                                        <th style={{ padding: '15px', textAlign: 'left', color: '#cbd5e1', fontWeight: '600' }}>名字</th>th>
                                                                                                        <th style={{ padding: '15px', textAlign: 'left', color: '#cbd5e1', fontWeight: '600' }}>行業</th>th>
                                                                                                        <th style={{ padding: '15px', textAlign: 'left', color: '#cbd5e1', fontWeight: '600' }}>電郵</th>th>
                                                                                                        <th style={{ padding: '15px', textAlign: 'left', color: '#cbd5e1', fontWeight: '600' }}>狀態</th>th>
                                                                                        </tr>tr>
                                                                  </thead>thead>
                                                                  <tbody>
                                                                      {experts.map(expert => (
                                                <tr key={expert.id} style={{ borderBottom: '1px solid #334155' }}>
                                                                      <td style={{ padding: '15px', color: '#e2e8f0' }}>{expert.name}</td>td>
                                                                      <td style={{ padding: '15px', color: '#e2e8f0' }}>{expert.industry}</td>td>
                                                                      <td style={{ padding: '15px', color: '#e2e8f0' }}>{expert.email}</td>td>
                                                                      <td style={{ padding: '15px', color: '#0ea5e9' }}>{expert.status}</td>td>
                                                </tr>tr>
                                              ))}
                                                                  </tbody>tbody>
                                                  </table>table>
                            ...
                            {showAddForm && (
                                        ...
                                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
                                            ...
                                            <div key={expert.id} style={{
                                                                  ...
                                                                  <h3 style={{ color: '#e2e8f0', marginBottom: '10px' }}>{expert.name}</h3>h3>
                                                                  <p style={{ color: '#94a3b8', margin: '5px 0' }}>{expert.industry}</p>p>
                                                                  <p style={{ color: '#94a3b8', margin: '5px 0' }}>{expert.email}</p>p>
                                                                  <p style={{ color: '#0ea5e9', margin: '10px 0' }}>{expert.status}</p>p>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))', gap: '20px' }}>
                            {templates.map((template, i) => (
                                          <div key={i} style={{
                                                              ...
                                                              <div style={{ fontSize: '40px', marginBottom: '15px' }}>{template.icon}</div>div>
                                                              <h3 style={{ color: '#e2e8f0', marginBottom: '8px' }}>{template.title}</h3>h3>
                                                              <p style={{ color: '#94a3b8', margin: 0, fontSize: '14px' }}>{template.desc}</p>p>
                                          </div>div>
                                        ))}
                        </div>div>
                      )}
                        ...
                        <div>
                                    <div style={{
                                          ...
                                          maxWidth: '600px'
                                                  ...
                                                  <p style={{ color: '#94a3b8', marginBottom: '20px' }}>選擇專家並通過 WhatsApp 發送邀請</p>p>
                                              ...
                                              <div key={expert.id} style={{
                                                                  ...
                                                                  <div>
                                                                                        <p style={{ color: '#e2e8f0', margin: '0 0 4px 0', fontWeight: '500' }}>{expert.name}</p>p>
                                                                                        <p style={{ color: '#94a3b8', margin: 0, fontSize: '14px' }}>{expert.email}</p>p>
                                                                  </div>div>
                                                                  <button style={{
                                                                        padding: '8px 16px',
                                                                        backgroundColor: '#10b981',
